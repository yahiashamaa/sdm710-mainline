 ...
 *
 * Adapted from the Snapdragon 845 interconnect driver.
 */
...
DEFINE_QNODE(xm_emmc, SDM670_MASTER_EMMC, 1, 8, SDM845_SLAVE_A1NOC_SNOC);
...
DEFINE_QNODE(qnm_mnoc_hf, SDM845_MASTER_MNOC_HF_MEM_NOC, 2, 32, SDM845_SLAVE_LLCC);
...
DEFINE_QNODE(qnm_aggre2_noc, SDM845_MASTER_A2NOC_SNOC, 1, 16, SDM845_SLAVE_APPSS, SDM845_SLAVE_SNOC_CNOC, SDM845_SLAVE_SNOC_MEM_NOC_SF, SDM845_SLAVE_IMEM, SDM845_SLAVE_PIMEM, SDM845_SLAVE_QDSS_STM, SDM845_SLAVE_TCU);
DEFINE_QNODE(qnm_gladiator_sodv, SDM845_MASTER_GNOC_SNOC, 1, 8, SDM845_SLAVE_APPSS, SDM845_SLAVE_SNOC_CNOC, SDM845_SLAVE_IMEM, SDM845_SLAVE_PIMEM, SDM845_SLAVE_QDSS_STM, SDM845_SLAVE_TCU);
...
static struct qcom_icc_node * const aggre1_noc_nodes[] = {
	...
	[MASTER_UFS_CARD] = NULL,
	[MASTER_UFS_MEM] = &xm_ufs_mem,
	[MASTER_PCIE_0] = NULL,
	[SLAVE_A1NOC_SNOC] = &qns_a1noc_snoc,
	[SLAVE_SERVICE_A1NOC] = &srvc_aggre1_noc,
	[SLAVE_ANOC_PCIE_A1NOC_SNOC] = NULL,
...
static struct qcom_icc_node * const config_noc_nodes[] = {
	...
	[SLAVE_PCIE_0_CFG] = NULL,
	[SLAVE_PCIE_1_CFG] = NULL,
	[SLAVE_PDM] = &qhs_pdm,
