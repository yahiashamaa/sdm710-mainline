...
/*
 * Qualcomm SDM670 interconnect IDs, based on SDM845 interconnect IDs
 *
 * Copyright (c) 2018, Linaro Ltd.
 * Original Author: Georgi Djakov <georgi.djakov@linaro.org>
 */
